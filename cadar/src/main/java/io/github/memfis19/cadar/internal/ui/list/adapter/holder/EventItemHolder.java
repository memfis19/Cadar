...
public class EventItemHolder extends RecyclerView.ViewHolder {
    ...
    private final String TIME_FROMAT = "HH:mm";
    ...
    public EventItemHolder(View itemView, Handler backgroundHandler, Handler uiHandler, final OnEventClickListener onEventClickListener) {
        super(itemView);
    ...
    public void bindView(final Event event, final ListItemModel previous, int position) {
        ...
        backgroundHandler.post(new Runnable() {
            ...
            public void run() {
                ...
                uiHandler.post(new Runnable() {
                    ...
                    public void run() {
                        if (displayDayIndicator) {
                            EventItemHolder.this.dayLabel.setVisibility(View.VISIBLE);
                            EventItemHolder.this.dayLabel.setText(dayLabelText);
                        } else EventItemHolder.this.dayLabel.setVisibility(View.INVISIBLE);
        ...
        SimpleDateFormat timeFormat = new SimpleDateFormat(TIME_FROMAT, DateUtils.getLocale());
